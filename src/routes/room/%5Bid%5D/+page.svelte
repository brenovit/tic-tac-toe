...
<div class="game-room">
  ...
  {:else}
    <div class="game-active">
      ...
      <!-- Game Board -->
      <div class="board" class:disabled={gameState !== 'playing' || currentPlayer !== playerSymbol}>
        {#each board as cell, index}
          <button
            class="cell"
            class:winning={winningCells.includes(index)}
            class:clickable={gameState === 'playing' && cell === null && currentPlayer === playerSymbol}
            on:click={() => handleCellClick(index)}
            disabled={gameState !== 'playing' || cell !== null || currentPlayer !== playerSymbol}
      ...
      {#if gameState === 'finished' || gameState === 'disconnected'}
        <div class="game-actions">
          <button on:click={handleNewGame} class="button primary">New Game</button>
        </div>
      {/if}
    </div>
  {/if}
